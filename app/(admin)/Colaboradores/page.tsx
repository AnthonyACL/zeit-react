...
export default function Page() {
  ...
  const handleSubmit = () => {
    if (modalMode === 'add') {
      ...
      setColaboradores(colaboradores.map(col => 
        col.id === selectedColaborador.id ? { ...formData, id: col.id } : col
      ));
    }
    setModalOpen(false);
    resetForm();
  ...
  const filteredInstituciones = institucionesOptions.filter(inst =>
                ...
                <tbody>
                  {filteredColaboradores.map((colaborador) => (
                    <tr key={colaborador.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-4 text-gray-700">{colaborador.correo}</td>
                      <td className="p-4 text-gray-700">{colaborador.telefono}</td>
                      <td className="p-4 text-gray-700">{colaborador.area}</td>
                      <td className="p-4 text-gray-700">{colaborador.institucion}</td>
                      <td className="p-4">
                        <button
              ...
              <div className="p-8">
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Nombre Completo</label>
                    <input
                      type="text"
                      name="nombre"
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">DNI</label>
                    <input
                      type="text"
                      name="dni"
                      value={formData.dni}
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Correo</label>
                    <input
                      type="email"
                      name="correo"
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Número de teléfono</label>
                    <input
                      type="tel"
                      name="telefono"
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Usuario</label>
                    <input
                      type="text"
                      name="usuario"
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Cargo</label>
                    <div className="flex-1 relative">
                      <button
                        type="button"
                        onClick={() => setShowCargoDropdown(!showCargoDropdown)}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center justify-between text-left"
                      >
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Área de trabajo</label>
                    <div className="flex-1 relative">
                      <input
                        type="text"
                        value={areaSearch}
                  ...
                  <div className="flex items-center gap-4">
                    <label className="w-48 text-right text-gray-700">Institucion</label>
                    <div className="flex-1 relative">
                      <input
                        type="text"
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                      {showInstitucionDropdown && filteredInstituciones.length > 0 && (
                        <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                ...
                <div className="flex justify-center gap-4 mt-8">
                  <button
                    ...
                    className="px-8 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg font-medium transition-colors"
                  >
